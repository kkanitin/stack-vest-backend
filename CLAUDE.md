...
pkg/
  config/               — Env-based config (SERVER_ADDRESS, MONGO_URI)
...
4. `internal/delivery/http/handler/` — Gin handler that calls the use case
5. `internal/delivery/http/router/router.go` — register the new routes
